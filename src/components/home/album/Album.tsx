...
const Album = () => {
  return (
    <>
      <div id='' className='w-[90%] mx-auto relative top-96 mb-[55rem]'>
        <div className="lg:flex sb">
            <div className='w-full sb'>
              <img src="/assests/images/album-min.png" alt="" />
            </div>
            <div className='w-full mt-36 sb'>
              <h2>NEW ALBUM</h2>
        ...
        <div className=' bg-fixed lg:w-[53%] h-max lg:absolute right-0 top-96 bg-dark_blue mt-32 p-12'>
    ...
    //   <div className='mt-80 grid lg:grid-cols-2 justify-items-center relative'>
    //       <div>
    //         <img src="/assests/images/album-min.png" alt="" />
    //       </div>
    ...
    //         <div className='mt-32 ml-[10rem]'>
    //           <h2>NEW ALBUM</h2>
    //           <h5 className='text-orange font-semibold tracking-widest text-4xl'>AVAILABLE NOW</h5>
              
    //         </div>

    //         <div className='bg-dark_blue mt-32 p-20  sb'>
    //           <div className='flex items-center gap-x-4 text-white'>
    ...
    //               <div>
    //               <h5 className='font-semibold text-4xl'>Now That We Found Love</h5>
    //               <h6 className='font-normal text-3xl'>Brain Damage</h6>
    //               </div>
    ...
    //             <RiPlayListLine className='bg-light_blue h-full w-[5%] ml-[57rem] text-center'/>
    //           </div>

    //           <div className='text-white h-[29rem] overflow-y-scroll mt-12 '>
    //             <ul className='bg-light_blue hover:bg-orange lg:text-3xl p-7 mb-1'>1. Now That We Found Love - Brain Damage</ul>
    //             <ul className='bg-light_blue hover:bg-orange lg:text-3xl p-7 mb-1'>2. Come With Me</ul>
    //             <ul className='bg-light_blue hover:bg-orange lg:text-3xl p-7 mb-1'>3. Jump Around</ul>
    //             <ul className='bg-light_blue hover:bg-orange lg:text-3xl p-7 mb-1'>4. Ridin Dirty</ul>
    //             <ul className='bg-light_blue hover:bg-orange lg:text-3xl p-7 mb-1'>5. Hate It or Love it</ul>
    //             <ul className='bg-light_blue hover:bg-orange lg:text-3xl p-7'>6. I Wanna Be yours</ul>
    //           </div>
